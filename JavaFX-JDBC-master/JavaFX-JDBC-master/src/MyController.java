...
*/
    ...
    public void handleButtonAction(ActionEvent event) {
        ...
        String query = "Insert into AHLAM(NAME,COURSE) VALUES('" + data1 + "','" + data2 + "')";
        try {
    ...
    public void PdfGenerate(){
        try{
            ...
            PdfWriter.getInstance(document,new FileOutputStream("C:/ahlam.pdf"));
